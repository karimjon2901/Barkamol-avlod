...
public class PhotoGalleryResources {
    ...
    public ResponseDto<PhotoGalleryDto> add(@Valid @ModelAttribute PhotoGalleryInputDto photoGalleryInputDto){
    ...
    public ResponseDto<PhotoGalleryDto> update(@Valid @ModelAttribute PhotoGalleryInputDto photoGalleryInputDto){
